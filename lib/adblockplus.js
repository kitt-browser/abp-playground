  ...
  var Notification = exports.Notification = {
    ...
    _onDownloadSuccess: function(downloadable, responseText, errorCallback, redirectCallback)
    {
      try
      {
        ...
        for (var _loopIndex31 = 0; _loopIndex31 < data.notifications.length; ++_loopIndex31)
        {
          var notification = data.notifications[_loopIndex31];
      ...
      for (var _loopIndex34 = 0; _loopIndex34 < notifications.length; ++_loopIndex34)
      {
        ...
        if (typeof url === "string" || notification.urlFilters instanceof Array)
        {
          if (typeof url === "string" && notification.urlFilters instanceof Array)
          {
            ...
            for (var _loopIndex35 = 0; _loopIndex35 < notification.urlFilters.length; ++_loopIndex35)
            {
              var urlFilter = notification.urlFilters[_loopIndex35];
        ...
        {
          var match = false;
          for (var _loopIndex36 = 0; _loopIndex36 < notification.targets.length; ++_loopIndex36)
          {
            var target = notification.targets[_loopIndex36];
    ...
    getLocalizedTexts: function(notification, locale)
    {
      ...
      var localizedTexts = [];
      for (var _loopIndex37 = 0; _loopIndex37 < textKeys.length; ++_loopIndex37)
      {
        var key = textKeys[_loopIndex37];
    ...
    triggerQuestionListeners: function(id, approved)
    {
      ...
      for (var _loopIndex38 = 0; _loopIndex38 < questionListeners.length; ++_loopIndex38)
      {
        var listener = questionListeners[_loopIndex38];
        listener(approved);
      }
    }
  };
...
require.scopes["antiadblockInit"] = (function()
{
  ...
  exports.initAntiAdblockNotification = function initAntiAdblockNotification()
  {
    ...
    {
      var urlFilters = [];
      for (var _loopIndex39 = 0; _loopIndex39 < subscription.filters.length; ++_loopIndex39)
      {
        var filter = subscription.filters[_loopIndex39];
        if (filter instanceof ActiveFilter)
        {
  ...
  window.URL = (function()
  {
    ...
    }))
    {
      ...
      URL = function(url, baseUrl)
      {
        ...
        anchor.href = url;
        for (var _loopIndex40 = 0; _loopIndex40 < URLProperties.length; ++_loopIndex40)
        {
          var prop = URLProperties[_loopIndex40];
...
require.scopes["whitelisting"] = (function()
{
  var exports = {};
  var defaultMatcher = require("matcher").defaultMatcher;
  var _tempVar41 = require("url");
  var stringifyURL = _tempVar41.stringifyURL;
  var getDecodedHostname = _tempVar41.getDecodedHostname;
  var extractHostFromFrame = _tempVar41.extractHostFromFrame;
  var isThirdParty = _tempVar41.isThirdParty;
  ...
  exports.processKey = function(token, page, frame)
  {
    ...
    var _tempVar42 = token.split("_", 2);
    var key = _tempVar42[0];
    var signature = _tempVar42[1];
    key = key.replace(/=/g, "");
...
require.scopes["filterValidation"] = (function()
{
  ...
  var Filter = _tempVar43.Filter;
  var InvalidFilter = _tempVar43.InvalidFilter;
...
require.scopes["filterComposer"] = (function()
{
  ...
  var _tempVar45 = require("whitelisting");
  var getKey = _tempVar45.getKey;
  var isFrameWhitelisted = _tempVar45.isFrameWhitelisted;
  var defaultMatcher = require("matcher").defaultMatcher;
  ...
  exports.composeFilters = function(details)
  {
    ...
    if (!isFrameWhitelisted(page, frame, "DOCUMENT"))
    {
      ...
      for (var _loopIndex46 = 0; _loopIndex46 < details.urls.length; ++_loopIndex46)
      {
        var url = details.urls[_loopIndex46];
      ...
      if (filters.length == 0 && !isFrameWhitelisted(page, frame, "ELEMHIDE"))
      {
        ...
        for (var _loopIndex47 = 0; _loopIndex47 < selectors.length; ++_loopIndex47)
        {
          var selector = selectors[_loopIndex47];
